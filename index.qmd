...
Just reading the data in is a challenge for some of these
...
start_x <- (eg$sensor_x - eg$manhattan):(eg$sensor_x + eg$manhattan)
start_y <- (eg$sensor_y - eg$manhattan):(eg$sensor_y + eg$manhattan)

half_y <- c((eg$manhattan):1, 0:eg$manhattan)



start_x[2:length(start_x)-1]  
